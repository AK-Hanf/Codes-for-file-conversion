...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Operation mode": "electron ionisation mass spectrometry",
            "m/z minimum setting": "electron ionisation mass spectrometry",
            "m/z maximum setting": "electron ionisation mass spectrometry",
            "Ionization energy": "electron ionisation mass spectrometry",
            "Electron beam current": "electron ionisation mass spectrometry"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\EIMS.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_EIMS"
