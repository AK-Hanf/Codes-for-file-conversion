...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "oxidizing gas composition": "temperature-programmed oxidation",
            "Heating rate": "temperature-programmed oxidation",
            "Minimum temperature": "temperature-programmed oxidation",
            "Maximum temperature": "temperature-programmed oxidation"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\TPO.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_TPO"
