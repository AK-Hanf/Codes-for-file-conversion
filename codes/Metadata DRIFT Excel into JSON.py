...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Adsorption gas": "diffuse reflectance infrared Fourier transform spectroscopy",
            "atmosphere": "diffuse reflectance infrared Fourier transform spectroscopy",
            "flow rate": "diffuse reflectance infrared Fourier transform spectroscopy",
            "Diluting reference": "diffuse reflectance infrared Fourier transform spectroscopy",
            "Ratio reference sample": "diffuse reflectance infrared Fourier transform spectroscopy",
            "Step size": "diffuse reflectance infrared Fourier transform spectroscopy",
            "Resolution": "diffuse reflectance infrared Fourier transform spectroscopy",
            "Background correction method": "diffuse reflectance infrared Fourier transform spectroscopy",
            "temperature": "diffuse reflectance infrared Fourier transform spectroscopy",
            "number of scans setting": "diffuse reflectance infrared Fourier transform spectroscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\DRIFT.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_DRIFT"
