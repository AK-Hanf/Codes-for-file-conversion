...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "element analyzed": "inductively-coupled plasma atomic emission spectroscopy",
            "calibration method": "inductively-coupled plasma atomic emission spectroscopy",
            "detection limit": "inductively-coupled plasma atomic emission spectroscopy",
            "matrix effect correction": "inductively-coupled plasma atomic emission spectroscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\ICP.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_ICP"
