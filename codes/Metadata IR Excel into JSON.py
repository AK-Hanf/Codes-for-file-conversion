...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "operation mode": "infrared spectroscopy",
            "Minimum wavenumber": "infrared spectroscopy",
            "Maximum wavenumber": "infrared spectroscopy",
            "step size": "infrared spectroscopy",
            "temperature": "infrared spectroscopy",
            "Background correction": "infrared spectroscopy",
            "Number of scans setting": "infrared spectroscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\IR.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_IR"
