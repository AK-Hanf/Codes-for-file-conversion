...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Excitation laser wavelength setting (Raman)": "Raman spectroscopy",
            "Excitation laser power setting (Raman)": "Raman spectroscopy",
            "Minimum wavenumber": "Raman spectroscopy",
            "Maximum wavenumber": "Raman spectroscopy",
            "magnification setting": "Raman spectroscopy",
            "Integration time": "Raman spectroscopy",
            "Atmosphere": "Raman spectroscopy",
            "Temperature": "Raman spectroscopy",
            "Number of scans setting": "Raman spectroscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\Raman.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_Raman"
