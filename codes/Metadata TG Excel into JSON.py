...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "atmosphere": "thermogravimetry",
            "operation mode": "thermogravimetry",
            "initial temperature": "thermogravimetry",
            "final temperature": "thermogravimetry",
            "heating rate": "thermogravimetry",
            "heating procedure": "thermogravimetry",
            "sample mass": "thermogravimetry"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\TG.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_TG"
