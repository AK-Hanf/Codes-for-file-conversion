...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Excitation wavelength setting": "photoluminescence spectroscopy",
            "Emission wavelength": "photoluminescence spectroscopy",
            "Optical filter": "photoluminescence spectroscopy",
            "Temperature": "photoluminescence spectroscopy",
            "Emission range": "photoluminescence spectroscopy",
            "Slit width": "photoluminescence spectroscopy",
            "Step size": "photoluminescence spectroscopy",
            "Integration time": "photoluminescence spectroscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\PL.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_PL"
