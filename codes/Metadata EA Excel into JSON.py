...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "element analyzed": "Elemental analysis",
            "combustion temperature": "Elemental analysis",
            "carrier gas": "Elemental analysis"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\EA.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_EA"
