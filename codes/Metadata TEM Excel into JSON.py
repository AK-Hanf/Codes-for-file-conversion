...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "gun type": "Transmission electron microscopy",
            "operation mode": "Transmission electron microscopy",
            "acceleration voltage": "Transmission electron microscopy",
            "magnification setting": "Transmission electron microscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\TEM.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_TEM"
