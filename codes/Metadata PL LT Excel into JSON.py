...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Excitation wavelength setting": "Photoluminescence lifetime measurement",
            "Emission wavelength": "Photoluminescence lifetime measurement",
            "Optical filter": "Photoluminescence lifetime measurement",
            "Temperature": "Photoluminescence lifetime measurement",
            "Lifetime fitting model": "Photoluminescence lifetime measurement",
            "Number of shots": "Photoluminescence lifetime measurement"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\PL LT.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_PL LT"
