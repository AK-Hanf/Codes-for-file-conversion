...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Atmosphere": "CO chemisorption",
            "Flow rate": "CO chemisorption",
            "heating procedure": "CO chemisorption",
            "measurement duration": "CO chemisorption",
            "sample mass": "CO chemisorption"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\CO.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_CO chemisorption"
