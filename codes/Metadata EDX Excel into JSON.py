...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Primary energy": "energy-dispersive X-ray emission spectroscopy",
            "Counting time": "energy-dispersive X-ray emission spectroscopy",
            "Resolution": "energy-dispersive X-ray emission spectroscopy",
            "Calibration method": "energy-dispersive X-ray emission spectroscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\EDX.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_EDX"
