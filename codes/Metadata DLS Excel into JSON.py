...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Solvent": "dynamic light scattering",
            "Concentration": "dynamic light scattering",
            "Light wavelength": "dynamic light scattering",
            "Scattering angle": "dynamic light scattering",
            "Refractive index": "dynamic light scattering",
            "Temperature": "dynamic light scattering",
            "Dispersant": "dynamic light scattering",
            "Measurement duration": "dynamic light scattering"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\DLS.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_DLS"
