...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "X-ray source": "X-ray absorption spectroscopy",
            "atmosphere": "X-ray absorption spectroscopy",
            "operation mode": "X-ray absorption spectroscopy",
            "element analyzed": "X-ray absorption spectroscopy",
            "absorption edge": "X-ray absorption spectroscopy",
            "monochromator": "X-ray absorption spectroscopy",
            "minimum energy": "X-ray absorption spectroscopy",
            "maximum energy": "X-ray absorption spectroscopy",
            "energy resolution": "X-ray absorption spectroscopy",
            "temperature": "X-ray absorption spectroscopy",
            "beamline source": "X-ray absorption spectroscopy",
            "noise of the measurement": "X-ray absorption spectroscopy",
            "number of cycles": "X-ray absorption spectroscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\XAS.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_XAS"
