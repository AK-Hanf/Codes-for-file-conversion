...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Minimum potential": "cyclic voltammetry",
            "Maximum potential": "cyclic voltammetry",
            "Step size potential": "cyclic voltammetry",
            "Electrolyte composition": "cyclic voltammetry",
            "Electrolyte concentration": "cyclic voltammetry",
            "Reference electrode": "cyclic voltammetry",
            "Number of cycles": "cyclic voltammetry",
            "Working electrode": "cyclic voltammetry",
            "Counter electrode": "cyclic voltammetry",
            "atmosphere": "cyclic voltammetry",
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\CV.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_CV"
