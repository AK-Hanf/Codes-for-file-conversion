...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "X-ray source": "X-ray photoelectron spectroscopy",
            "atmosphere": "X-ray photoelectron spectroscopy",
            "Total acquisition time": "X-ray photoelectron spectroscopy",
            "Number of scans": "X-ray photoelectron spectroscopy",
            "Spot size": "X-ray photoelectron spectroscopy",
            "Lense mode": "X-ray photoelectron spectroscopy",
            "minimum energy": "X-ray photoelectron spectroscopy",
            "maximum energy": "X-ray photoelectron spectroscopy",
            "step size": "X-ray photoelectron spectroscopy",
            "pass energy": "X-ray photoelectron spectroscopy",
            "charge compensation": "X-ray photoelectron spectroscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\XPS.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_XPS"
