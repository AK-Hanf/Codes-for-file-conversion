...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "X-ray source": "powder X-ray diffraction",
            "atmosphere": "powder X-ray diffraction",
            "operation mode": "powder X-ray diffraction",
            "Minimum 2 theta": "powder X-ray diffraction",
            "Maximum 2 theta": "powder X-ray diffraction",
            "Step size": "powder X-ray diffraction",
            "Monochromator": "powder X-ray diffraction",
            "Temperature": "powder X-ray diffraction",
            "Sample spinning speed": "powder X-ray diffraction",
            "total measurement duration setting": "powder X-ray diffraction"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\PXRD.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_PXRD"
