...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Electrode configuration": "Conductivity Measurement",
            "frequency": "Conductivity Measurement",
            "AC or DC mode": "Conductivity Measurement",
            "Sample geometry": "Conductivity Measurement"
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\Conductivity.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_Conductivity"
