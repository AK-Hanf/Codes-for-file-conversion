...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "Reducing gas composition": "temperature-programmed reduction",
            "Heating rate": "temperature-programmed reduction",
            "Minimum temperature": "temperature-programmed reduction",
            "Maximum temperature": "temperature-programmed reduction"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\TPR.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_TPR"
