...
def excel_sheet_to_nested_json(df, json_output_path):
    ...
    try:
        ...
        key_map = {
            ...
            "gun type": "scanning electron microscopy",
            "acceleration voltage": "scanning electron microscopy",
            "Image resolution": "scanning electron microscopy",
            "field emitter": "scanning electron microscopy"
        }
...
excel_file_path = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\SEM.xlsx"
output_folder = r"C:\Users\Arbeit\Desktop\learntocode\Carbodiol Characterisation\json_outputs_SEM"
